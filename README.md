...
游戏过程中会进行至多五次【任务】，【骑士】（蓝方）要确保任务成功**且**保护【梅林】，【反抗军】（红方）要破坏任务**或**找出【梅林】，将其【刺杀】。

【任务】将由一名【队长】指定若干名【队员】执行，在完成指定后，【所有玩家】将进行一轮讨论，并**公开投票**决定该任务是否执行。任务执行后，【队员】将进行**匿名投票**决定任务是否成功。
...
- **骑士阵营（蓝方）**  
  - **胜利目标**：使三轮任务成功。
  - **角色能力**：
    - **【梅林】 (Loyal Coutier)**：夜晚阶段可查看所有红方玩家。
    - **【派西维尔】 (Percival)**：夜晚阶段只能看到【梅林】和【莫甘娜】，**且无法区分两者**。
    - **【骑士】 (Knight)**：无特殊能力。夜晚阶段无法查看任何人，也无法被任何人看到。
...
- **反抗军阵营（红方）**
  ...
  - **角色能力**：
    ...
    - **【奥伯伦】 (Oberon)**：独狼。夜晚阶段无法查看任何人，也无法被任何人看到。
...
我们预计在**4月29日**发布可用的大作业对战平台，届时一大批优秀的代码（也许不止是我们班的）将相继涌入。

**不会写代码？接口不知道怎么接？**请参阅 [对战平台用户文档](./documentation/document4users/README.md)。

我在这里代表**文档小组**承诺😋：保证大作业对战平台面向用户的文档清晰、可读、上手快。

<span style="font-size: smaller;">对文档的忠诚不绝对就是绝对不忠诚！</span>

各小组可以通过发起对战来找到自己代码中可以优化的地方，并不断更新迭代自己的代码，使之成为一个“巨能打”的完全体！
