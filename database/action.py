...
def get_leaderboard(ranking_id=0, page=1, per_page=15, min_games_played=0):
    ...
    for rank, (
        ...
        win_rate_for_container = round(wins / games_played * 100, 1) if games_played > 0 else 0
        loss_rate_for_container = round(losses / games_played * 100, 1) if games_played > 0 else 0  
        draw_rate_for_container = round(draws / games_played * 100, 1) if games_played > 0 else 0
        result.append(
            {
                "rank": rank,
                "user_id": user_id,
