...
class Player:
    ...
    def analyze_gathering(self):
        ...
        if distances:
            ...
            write_into_private(f"最近的玩家是{closest_player}号，距离{distances[closest_player]}格")
    ...
    def decide_mission_member(self, team_size: int) -> list[int]:
        ...
        if self.is_evil:
            ...
            remaining = [i for i in range(1, self.player_count+1) 
            ...
            # 如果信任的玩家不足，补充未被怀疑的玩家
            neutral = [i for i in range(1, self.player_count+1) 
    ...
    def say(self) -> str:
        ...
        if self.speech_strategy == "subtle_hint" and self.role == "Merlin":
            ...
            # 邪恶方欺骗性发言
            good_players = [i for i in range(1, self.player_count+1) 
    ...
    def mission_vote1(self) -> bool:
        ...
        # 善良方策略
            ...
            if suspicious_in_team > 0:
                write_into_private(f"反对提案，因为队伍中有{suspicious_in_team}名可疑玩家")
                return False
